...
const ListItems = () => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const { data } = await axios.get('https://full-stack-food-delivery-platform-backend.onrender.com/api/items');
        setItems(data);
      } catch (err) {
  ...
  const handleDelete = async (itemId) => {
    ...
    try {
      await axios.delete(`https://full-stack-food-delivery-platform-backend.onrender.com/api/items/${itemId}`);
